 ...
 * An assignment is canonical if no combination of group- and edge-automorphisms maps [edge->voltage for edge in edges] to a lexicographically smaller list
 *
 ...
 * @param group A group.
 * @param setup A runSetup struct containing the settings for the run. Indicates whether to use group- and edge-automorphisms.
